...
public final class Constants {
    ...
    public static final String MENUBAR_COLOR = "menubar.color";
    public static final String MENUBAR_WIDTH = "menubar.width";
    public static final String MENUBAR_HEIGHT = "menubar.height";
